...
#pragma endregion
	...
	private: array<PointF>^ initSandWatch(array<PointF>^ p) {
		p = gcnew array<PointF>(7);

		p[0] = PointF(x0, y0);
		p[1] = PointF(x0 + r, y0 - r);
		p[2] = PointF(x0 - r, y0 - r);
		p[3] = PointF(x0, y0);
		p[4] = PointF(x0 + r, y0 + r);
		p[5] = PointF(x0 - r, y0 + r);
		p[6] = PointF(x0, y0);
